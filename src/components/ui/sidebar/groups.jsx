...
export function SidebarGroup({ className, ...p }) {
    return <div data-slot="sidebar-group" data-sidebar="group" className={cn("relative flex w-full min-w-0 flex-col p-2", className)} {...p} />
}

export function SidebarGroupLabel({ className, asChild = false, ...p }) {
...
export function SidebarGroupAction({ className, asChild = false, ...p }) {
...
export function SidebarGroupContent({ className, ...p }) {
    return <div data-slot="sidebar-group-content" data-sidebar="group-content" className={cn("w-full text-sm", className)} {...p} />
}
